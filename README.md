...
This repository contains exercise sheets for the [Analysis](https://ocasys.rug.nl/current/catalog/course/WBMA012-05) course at the University of Groningen. The material is based on the one available from the [waterproof-exercise-sheets](https://github.com/impermeable/waterproof-exercise-sheets) and [introduction-to-proofs](https://github.com/impermeable/introduction-to-proof-sheets) repositories.
